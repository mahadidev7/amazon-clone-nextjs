    ...
    <header id="sticky">
      ...
      <div className="flex items-center bg-amazon_blue p-1 flex-grow py-2 ">
        ...
        <div className="hidden relative sm:flex items-center h-10 cursor-pointer rounded-md flex-grow bg-white">
          ...
          />
          <BsSearch
            className="h-10 p-3 text-bold bg-yellow-400 hover:bg-yellow-500 rounded-tr-md rounded-br-md"
            color="#000"
            size={60}
          />
        ...
        <div className="text-white flex items-center text-xs space-x-0 md:space-x-6 md:mx-6 mx-1 whitespace-nowrap py-2">
          ...
          >
            <span className="absolute top-0 left-6 h-5 w-5 bg-yellow-400 flex items-center justify-center rounded-full text-black font-bold">
              {basketLength.length}
            </span>
      ...
      <div className="flex items-center space-x-2 py-3 px-3 text-sm text-white bg-[#232F3E] overflow-auto">
        ...
        <Link href={"./Allproduct"}>
          <p className="link whitespace-nowrap">@mahadidev7</p>
        </Link>
      </div>
    </header>
  );
